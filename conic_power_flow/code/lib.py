...
class grid:
    ...
    def pf(self):
        ...
        print("Los índices de la matriz X relacionados con la línea 0 son: ", self.lines[0].Ckt, self.lines[0].Skt)        
        ...
        for i in range(2, 2*n, 2):
            ...
            for j in range(i // 2, x_size):
                columna = j
                SumaG, SumaB = self.cuenta_1(columna, lineas)
                G_ant, B_ant = self.cuenta_2(columna, lineas)
                G_post, B_post = self.cuenta_3(columna, lineas)
